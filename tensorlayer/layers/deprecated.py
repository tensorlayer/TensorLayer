...
def DynamicRNNLayer(*args, **kwargs):
    raise NonExistingLayerError("DynamicRNNLayer(x, is_train=True, name='a') --> DynamicRNN(name='a')(x)" + __log__)


def BiDynamicRNNLayer(*args, **kwargs):
    raise NonExistingLayerError("BiDynamicRNNLayer(x, is_train=True, name='a') --> BiDynamicRNN(name='a')(x)" + __log__)
