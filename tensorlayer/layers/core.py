...
class Layer(object):
    ...
    def __init__(self, prev_layer, act=None, name=None, *args, **kwargs):
        ...
        self.inputs = None
        self.outputs = None
        # self.graph = {}     # remove graph
        self.all_layers = list()
        self.all_params = list()
        self.all_drop = dict()
        # self.all_graphs = list()  # remove graph

        # self.layer_args = self._get_init_args(skip=4) # remove graph
        ...
        if isinstance(prev_layer, Layer):
            ...
            # self._add_graphs(prev_layer.all_graphs) # remove graph
            ...
            # self._add_graphs(sum([l.all_graphs for l in prev_layer], [])) # remove graph
    ...
    def __getitem__(self, key):
        ...
        # net_new._add_graphs(self.all_graphs) # remove graph
