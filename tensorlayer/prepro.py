...
def crop_meta_image(image,annos,mask):
    """Return image, annotations and mask after random crop

       Parameters
       -----------
       image : three channels 3D array
           read image
       pad_val : list of list
           keypoints of people in image
       mask : single channel 2D array
           single channel image

       Returns
       ----------
       image, annotations and mask after adjustment
...
def _resize_image(image,annos,mask,_target_width,_target_height):
    """Return image, annotations and mask give resisze target height width
...
def pose_rotation(image,annos,mask):
    """Return image, annotations and mask after random rotation
...
def random_flip(image,annos,mask_miss):
    """Return image, annotations and mask after random flip
...
def pose_random_scale(image,annos,mask_miss):
    """Return image, annotations and mask after random scale
...
def pose_resize_shortestedge_random(image,annos, mask):
    """Return image, annotations and mask after random resize edge
