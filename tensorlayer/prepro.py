...
__all__ = [
    ...
    'sequences_get_mask',
    'keypoint_crop_random',
    'keypoint_random_flip',
    'keypoint_random_scale',
    'keypoint_resize_shortestedge_random',
    'keypoints_direct_crop',
    'keypoints_rotation',
]
...
def keypoints_direct_crop(image,annos,mask):
...
def keypoints_rotation(image,annos,mask):
...
def keypoint_random_flip(image,annos,mask_miss):
    """flip image and keypoints
...
def keypoint_random_scale(image,annos,mask_miss):
    """Reszie image and corresponding keypoints
...
def keypoint_resize_shortestedge_random(image,annos, mask):
    """Reszie based on shorter edge with padding
...
def keypoint_crop_random(image,annos,mask):
    """random crop padded image given by keypoint_resize_shortestedge_random
