...
def model(x, is_train=True, reuse=False):
    ...
    with tf.variable_scope("binarynet", reuse=reuse):
        ...
        net = tl.layers.TernaryConv2d(32, (5, 5), (1, 1), padding='SAME', b_init=None, name='bcnn1')(net)
        ...
        # net = tl.layers.SignLayer()
        net = tl.layers.TernaryConv2d(64, (5, 5), (1, 1), padding='SAME', b_init=None, name='bcnn2')(net)
        ...
        net = tl.layers.TernaryDenseLayer(net, 256, b_init=None, name='dense')(net)
        ...
        # net = tl.layers.SignLayer()(net)
        net = tl.layers.TernaryDenseLayer(10, b_init=None, name='bout')(net)
