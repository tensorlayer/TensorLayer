...
- *Performance* : TensorLayer provides **zero-cost** compatibility (see Benchmark below). It can run on distributed and heterogeneous TensorFlow platforms.
...
# Comparison with Keras, TFSlim and TFLearn
