...
# for float16 epsilon=1e-4, for float32 epsilon=1e-08, see https://stackoverflow.com/questions/42064941/tensorflow-float16-support-is-broken
train_op = tf.train.AdamOptimizer(learning_rate=0.0001, epsilon=1e-4).minimize(cost, var_list=train_params)
