...
from tf_data_aug import crop_meta_image, _resize_image, pose_rotation, random_flip, pose_resize_shortestedge_random, pose_crop_random, pose_random_scale
    ...
    while (True):
        ...
        if gs_num != 0 and gs_num % 5000 == 0:
            ...
            tl.files.save_npz_dict(
                net.all_params, '/home/hao/Workspace/yuding/pose-paf-master/model/inf_model' + str(gs_num) + '.npz',
                sess=sess
            )
        if gs_num > 3000001:
            break
