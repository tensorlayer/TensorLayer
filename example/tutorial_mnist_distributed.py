...
with tf.device(device_fn):
    ...
    with tl.distributed.DistributedSession(task_spec=task_spec) as sess:
        ...
        # train the network
        tl.utils.fit(sess, network, train_op, cost, X_train, y_train, x, y_, acc=acc, batch_size=500, n_epoch=500, print_freq=print_freq, X_val=X_val, y_val=y_val, eval_train=eval_train)
