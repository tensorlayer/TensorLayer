...
class InputLayer(Layer):
    ...
    def __init__(
        ...
        print("  TuneLayer:Instantiate InputLayer %s %s" % (self.name, inputs._shape))
...
class Word2vecEmbeddingInputlayer(Layer):
    ...
    Examples
    --------
    >>> Without TuneLayer : see tensorflow/examples/tutorials/word2vec/word2vec_basic.py
    ...
    >>> With TuneLayer : see tutorial_word2vec_basic.py
    >>> train_inputs = tf.placeholder(tf.int32, shape=[batch_size])
    >>> train_labels = tf.placeholder(tf.int32, shape=[batch_size, 1])
    ...
    def __init__(
        ...
        print("  TuneLayer:Instantiate Word2vecEmbeddingInputlayer %s (%d, %d)" % (self.name, vocabulary_size, embedding_size))
...
class EmbeddingInputlayer(Layer):
    ...
    def __init__(
        ...
        self.inputs = inputs
        self.n_units = embedding_size
        print("  TuneLayer:Instantiate EmbeddingInputlayer %s (%d, %d)" % (self.name, vocabulary_size, embedding_size))
...
class DenseLayer(Layer):
    ...
    ...                 )
    ...
    >>> Without TuneLayer, you can do as follow.
    >>> W = tf.Variable(
    ...
    def __init__(
        ...
        print("  TuneLayer:Instantiate DenseLayer %s: %d, %s" % (self.name, self.n_units, act))
        with tf.variable_scope(name) as vs:
...
class ReconLayer(DenseLayer):
    ...
    def __init__(
        ...
        print("     TuneLayer: %s is a ReconLayer" % self.name)
    ...
    def pretrain(self, sess, x, X_train, X_val, denoise_name=None, n_epoch=100, batch_size=128, print_freq=10,
        ...
        #
        # ====================================================
        print("     TuneLayer:  %s start pretrain" % self.name)
...
class DropoutLayer(Layer):
    ...
    def __init__(
        ...
        Layer.__init__(self, name=name)
        self.inputs = layer.outputs
        print("  TuneLayer:Instantiate DropoutLayer %s: keep: %f" % (self.name, keep))
...
class DropconnectDenseLayer(Layer):
    ...
    def __init__(
        ...
        n_in = int(self.inputs._shape[-1])
        self.n_units = n_units
        print("  TuneLayer:Instantiate DropconnectDenseLayer %s: %d, %s" % (self.name, self.n_units, act))
...
class Conv2dLayer(Layer):
    ...
    ...
    >>> Without TuneLayer, you can initialize the parameters as follow.
    ...
    def __init__(
        ...
        Layer.__init__(self, name=name)
        self.inputs = layer.outputs
        print("  TuneLayer:Instantiate Conv2dLayer %s: %s, %s, %s, %s" %
...
class PoolLayer(Layer):
    ...
    def __init__(
        ...
        Layer.__init__(self, name=name)
        self.inputs = layer.outputs
        print("  TuneLayer:Instantiate PoolLayer %s: %s, %s, %s, %s" %
...
class RNNLayer(Layer):
    ...
    def __init__(
        ...
        print("  TuneLayer:Instantiate RNNLayer %s: n_hidden:%d, n_steps:%d, in_dim:%d %s, cell_fn:%s " % (self.name, n_hidden,
...
class FlattenLayer(Layer):
    ...
    def __init__(
        ...
        print("  TuneLayer:Instantiate FlattenLayer %s, %d" % (self.name, self.n_units))
        self.all_layers = list(layer.all_layers)
        self.all_params = list(layer.all_params)
        self.all_drop = dict(layer.all_drop)
        self.all_layers.extend( [self.outputs] )
...
class ConcatLayer(Layer):
    ...
    ...     TuneLayer:Instantiate DenseLayer relu1_1: 800, <function relu at 0x1108e41e0>
    ...     TuneLayer:Instantiate DenseLayer relu2_1: 300, <function relu at 0x1108e41e0>
    ...     TuneLayer:Instantiate ConcatLayer concat_layer, 1100
    ...
    >>> sess.run(tf.initialize_all_variables())
    ...
    def __init__(
        ...
        self.n_units = int(self.outputs._shape[-1])
        print("  TuneLayer:Instantiate ConcatLayer %s, %d" % (self.name, self.n_units))
...
class ReshapeLayer(Layer):
    ...
    def __init__(
        ...
        print("  TuneLayer:Instantiate ReshapeLayer %s" % (self.name))
        self.all_layers = list(layer.all_layers)
        self.all_params = list(layer.all_params)
        self.all_drop = dict(layer.all_drop)
        self.all_layers.extend( [self.outputs] )
...
class MaxoutLayer(Layer):
    ...
    def __init__(
        ...
        print("  TuneLayer:Instantiate MaxoutLayer %s: %d" % (self.name, self.n_units))
        with tf.variable_scope(name) as vs:
            pass
...
class GaussianNoiseLayer(Layer):
    ...
    def __init__(
        ...
        Layer.__init__(self, name=name)
        self.inputs = layer.outputs
        print("  TuneLayer:Instantiate GaussianNoiseLayer %s: keep: %f" % (self.name, keep))
        with tf.variable_scope(name) as vs:
            pass
...
class BidirectionalRNNLayer(Layer):
    ...
    def __init__(
        ...
        print("  TuneLayer:Instantiate BidirectionalRNNLayer %s: n_hidden:%d, n_steps:%d, dim:%d %s" % (self.name, n_hidden,
...
class Conv3dLayer(Layer):
    ...
    def __init__(
        ...
        Layer.__init__(self, name=name)
        self.inputs = layer.outputs
        print("  TuneLayer:Instantiate Conv3dLayer %s: %s, %s, %s, %s" % (self.name, str(shape), str(strides), padding, act))
