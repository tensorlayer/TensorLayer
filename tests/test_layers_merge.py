...
class Layer_Merge_Test(CustomTestCase):
    ...
    def setUpClass(cls):
        ...
        inputs = tl.layers.InputLayer(name='input_layer')(x)

        net_v1_1 = tl.layers.DenseLayer(n_units=100, act=tf.nn.relu, name='relu1_1')(inputs)
        net_v1_2 = tl.layers.DenseLayer(n_units=100, act=tf.nn.relu, name='relu2_1')(inputs)
        net_v1 = tl.layers.ConcatLayer(concat_dim=1, name='concat_layer')([net_v1_1, net_v1_2])
        ...
        net_v2_1 = tl.layers.DenseLayer(n_units=100, act=tf.nn.relu, name='net_0')(inputs)
        net_v2_2 = tl.layers.DenseLayer(n_units=100, act=tf.nn.relu, name='net_1')(inputs)
        net_v2 = tl.layers.ElementwiseLayer(combine_fn=tf.minimum, name='minimum')([net_v2_1, net_v2_2])
        ...
        net_v3_1 = tl.layers.DenseLayer(n_units=100, act=tf.nn.relu, name='net_a')(inputs)
        net_v3_2 = tl.layers.DenseLayer(n_units=100, act=tf.nn.relu, name='net_b')(inputs)
        net_v3 = tl.layers.ElementwiseLambdaLayer(fn=lambda a, b: a * b, name='multiply')([net_v3_1, net_v3_2])
        ...
        inputs = tl.layers.InputLayer(name='input')(x)
        ...
        net_im1 = tl.layers.ConcatLayer(concat_dim=-1, name='concat')([net_im1_1, net_im1_2])
        ...
        net_im2 = tl.layers.ElementwiseLayer(combine_fn=tf.minimum, name='minimum2')([net_im1_1, net_im1_2])
        ...
        net_im3 = tl.layers.ElementwiseLambdaLayer(fn=lambda a, b: a * b, name='multiply2')([net_im1_1, net_im1_2])
