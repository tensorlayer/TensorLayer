...
class Layer_Convolution_1D_Test(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.n1 = tl.layers.Conv1dLayer(
            cls.input_layer, shape=(5, 1, 32), stride=2)
...
class Layer_Convolution_2D_Test(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.n10 = tl.layers.TernaryConv2d(
            cls.n9,
            64, (5, 5), (1, 1),
            act=tf.nn.relu,
            padding='SAME',
        ...
        cls.n11 = tl.layers.AtrousDeConv2dLayer(
            cls.n10,
            shape=(3, 3, 32, 64),
            output_shape=(100, 96, 96, 32),
            rate=2,
            act=tf.nn.relu,
            name='atroustrans1')

        cls.n12 = tl.layers.QuanConv2d(
            cls.n11,
            64, (5, 5), (1, 1),
            act=tf.nn.relu,
            padding='SAME',
    ...
    def test_layer_n1(self):
        ...
        self.assertEqual(self.n1.outputs.get_shape().as_list()[1:],
                         [50, 50, 32])
    ...
    def test_layer_n2(self):
        ...
        self.assertEqual(self.n2.outputs.get_shape().as_list()[1:],
                         [25, 25, 32])
    ...
    def test_layer_n3(self):
        ...
        self.assertEqual(self.n3.outputs.get_shape().as_list()[1:],
                         [13, 13, 32])
    ...
    def test_layer_n4(self):
        ...
        self.assertEqual(self.n4.outputs.get_shape().as_list()[1:],
                         [200, 200, 32])
    ...
    def test_layer_n5(self):
        ...
        self.assertEqual(self.n5.outputs.get_shape().as_list()[1:],
                         [400, 400, 32])
    ...
    def test_layer_n6(self):
        ...
        self.assertEqual(self.n6.outputs.get_shape().as_list()[1:],
                         [200, 200, 64])
    ...
    def test_layer_n7(self):
        ...
        self.assertEqual(self.n7.outputs.get_shape().as_list()[1:],
                         [100, 100, 32])
    ...
    def test_layer_n8(self):
        ...
        self.assertEqual(self.n8.outputs.get_shape().as_list()[1:],
                         [50, 50, 32])
    ...
    def test_layer_n9(self):
        ...
        self.assertEqual(self.n9.outputs.get_shape().as_list()[1:],
                         [48, 48, 32])
    ...
    def test_layer_n10(self):
        ...
        self.assertEqual(self.n10.outputs.get_shape().as_list()[1:],
                         [48, 48, 64])
    ...
    def test_layer_n11(self):
        ...
        self.assertEqual(self.n11.outputs.get_shape().as_list()[1:],
                         [96, 96, 32])
    ...
    def test_layer_n12(self):
        ...
        self.assertEqual(self.n12.outputs.get_shape().as_list()[1:],
                         [96, 96, 64])
...
class Layer_Convolution_3D_Test(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.n1 = tl.layers.Conv3dLayer(
            cls.input_layer, shape=(2, 2, 2, 3, 32), strides=(1, 2, 2, 2, 1))

        cls.n2 = tl.layers.DeConv3dLayer(
            cls.n1,
            shape=(2, 2, 2, 128, 32),
            output_shape=(100, 12, 32, 32, 128),
            strides=(1, 2, 2, 2, 1))

        cls.n3 = tl.layers.DeConv3d(
            cls.n2, n_filter=32, filter_size=(3, 3, 3), strides=(2, 2, 2))
...
class Layer_DeformableConvolution_Test(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.net1 = tl.layers.DeformableConv2d(
            net, offset1, 32, (3, 3), act=tf.nn.relu, name='deformable1')
        ...
        cls.net2 = tl.layers.DeformableConv2d(
            cls.net1, offset2, 64, (3, 3), act=tf.nn.relu, name='deformable2')
    ...
    def test_layer_n1(self):
        ...
        self.assertEqual(self.net1.outputs.get_shape().as_list()[1:],
                         [299, 299, 32])
    ...
    def test_layer_n2(self):
        ...
        self.assertEqual(self.net2.outputs.get_shape().as_list()[1:],
                         [299, 299, 64])
